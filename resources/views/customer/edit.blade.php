        ...
        <div class="table-responsive">
            <form method="POST" enctype="multipart/form-data" action="{{url('admin/customer/'.$data->id)}}">
                ...
                <table class="table table-bordered">
                    ...
                    <tr>
                        <th>Email</th>
                        <td><input value="{{$data->email}}" type="email" class="form-control" name="email"></td>
                    </tr>
                    <tr>
                        <th>Mobile No.</th>
                        <td><input value="{{$data->mobile_number}}" type="text" class="form-control" name="mobile"></td>
                    </tr>
                    <tr>
                        <th>Photo</th>
                        <td>
                    ...
                    <tr>
                        <th>Address</th>
                        <td><input value="{{$data->address}}" type="text" class="form-control" name="address"></td>
                    </tr>
